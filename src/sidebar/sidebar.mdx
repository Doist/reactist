...
| \`--reactist-sidebar-overlay-inset-block-start\` | \`0px\` | Top inset alone, e.g. below a title bar (defaults to \`-inset-block\`) |
| \`--reactist-sidebar-overlay-inset-block-end\` | \`0px\` | Bottom inset alone (defaults to \`-inset-block\`) |
