...
import type { NativeProps, ObfuscatedClassName, Space } from '../utils/common-types'
...
interface TabPanelProps extends NativeProps<HTMLDivElement>, Pick<BaseTabPanelProps, 'render'> {
