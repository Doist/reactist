...
export function Template({ label, ...props }) {
    let textLabel = label
    if (label === 'Click me <em>now</em>') {
        label = (
            <>
    ...
    return (
        <Stack space="large">
            ...
            <Inline space="large">
                <Stack space="large">
                    <Box maxWidth="xsmall">
                        <LoadingButtonLink {...props}>{label}</LoadingButtonLink>
                    </Box>
                    <Box maxWidth="xsmall">
                        <LoadingButtonLink {...props} disabled>
                            {label}
                        </LoadingButtonLink>
                    </Box>
                </Stack>
                <Stack space="large">
                    <Box maxWidth="xsmall">
                        <LoadingButtonLink {...props} startIcon={<Icon />}>
                            {label}
                        </LoadingButtonLink>
                    </Box>
                    <Box maxWidth="xsmall">
                        <LoadingButtonLink {...props} startIcon={<Icon />} disabled>
                            {label}
                        </LoadingButtonLink>
                    </Box>
                </Stack>
                <Stack space="large">
                    <Box maxWidth="xsmall">
                        <LoadingButtonLink {...props} endIcon={<Icon />}>
                            {label}
                        </LoadingButtonLink>
                    </Box>
                    <Box maxWidth="xsmall">
                        <LoadingButtonLink {...props} endIcon={<Icon />} disabled>
                            {label}
                        </LoadingButtonLink>
                    </Box>
                </Stack>
