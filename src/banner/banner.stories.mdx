    ...
    return (
        <Stack space="medium" align="start">
            <Stack space="large">
                ...
                />
                <Banner tone="neutral" description="This is a neutral message without an icon" />
                <Banner tone="info" description="This is an info message" />
                <Banner tone="upgrade" description="This is a upgrade message" />
                <Banner tone="experiment" description="This is an experimentalist message" />
                <Banner tone="warning" description="This is a warning message" />
                <Banner tone="error" description="This is a error message" />
                <Banner tone="success" description="This is a success message" />
            </Stack>
        </Stack>
    )
}
...
export function DarkModeTemplate() {
    return (
        <Box
            ...
            gap="large"
        >
            <Banner tone="neutral" icon={<ArchiveIcon />} description="This is a neutral message" />
            <Banner
                tone="neutral"
