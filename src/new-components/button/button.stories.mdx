...
<Button
    ...
    style={{
        ...
        '--reactist-actionable-primary-idle-border-color': '#222',
        '--reactist-btn-hover-tint': '#fff',
        '--reactist-btn-hover-fill': '#777',
        '--reactist-actionable-primary-hover-border-color': '#111',
        '--reactist-btn-disabled-tint': '#fff',
        '--reactist-btn-disabled-fill': '#ccc',
        '--reactist-actionable-primary-disabled-border-color': '#999',
    }}
>
    Click me
</Button>
