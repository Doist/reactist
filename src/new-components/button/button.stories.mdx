...
<Canvas>
    <Story parameters={{ docs: { source: { type: 'dynamic' } } }} name="Icon-only buttons">
        <Stack space="large">
            <Inline space="large">
                <Box>
...
### Icon-only button with custom tooltip

You can suppress the automatically-generated tooltip in icon-only buttons by explicitly passing `tooltip={null}`.

<Canvas>
    <Story
        parameters={{ docs: { source: { type: 'dynamic' } } }}
        name="Icon-only button with custom tooltip"
    >
        <Tooltip content="Add task now">
            <Button
                variant="primary"
                aria-label="Add task"
                icon={<Icon />}
                tooltip={null} // This is the key
            />
        </Tooltip>
    </Story>
</Canvas>
