    ...
    return (
        <Box
            ...
            style={{
                ...
                '--reactist-actionable-primary-destructive-idle-tint': '#eceeee',
                '--reactist-actionable-primary-destructive-idle-fill': '#de4c4a',
                '--reactist-actionable-primary-destructive-hover-tint': '#fff',
                '--reactist-actionable-primary-destructive-hover-fill': '#e26160',
                '--reactist-actionable-primary-destructive-disabled-tint': '#767777',
                '--reactist-actionable-primary-destructive-disabled-fill': '#6e261f',
