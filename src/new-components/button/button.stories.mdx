...
export function Template({ label, variant, tone, size }) {
    ...
    return (
        <Inline space="large">
            ...
            <Stack space="large">
                <Box>
                    <Button variant={variant} tone={tone} size={size} startIcon={<Icon />}>
                        {label}
                    </Button>
                </Box>
                <Box>
                    <Button variant={variant} tone={tone} size={size} startIcon={<Icon />} disabled>
                        {label}
                    </Button>
                </Box>
            </Stack>
            <Stack space="large">
                <Box>
                    <Button variant={variant} tone={tone} size={size} endIcon={<Icon />}>
                        {label}
                    </Button>
                </Box>
                <Box>
                    <Button variant={variant} tone={tone} size={size} endIcon={<Icon />} disabled>
                        {label}
                    </Button>
                </Box>
            </Stack>
