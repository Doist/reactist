...
<Canvas withToolbar>
    <Story parameters={{ docs: { source: { type: 'dynamic' } } }} name="Nested modals">
        <ModalStoryStateProvider>
            <Button variant="primary">Open modal</Button>
            <Modal width="large" height="expand" aria-label="Outer modal">
                <ModalHeader>
                    <Heading level="1">Outer modal title</Heading>
                </ModalHeader>
                <ModalBody>
                    <ModalStoryStateProvider>
                        <Button variant="primary">Open nested modal</Button>
                        <Modal width="small" height="fitContent" aria-label="Outer modal">
                            <ModalHeader>
                                <Heading level="1">Nested modal title</Heading>
                            </ModalHeader>
                            <ModalBody>Nothing to see here</ModalBody>
                            <ModalActions>
