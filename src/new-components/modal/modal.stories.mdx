...
🎨 [Figma](https://www.figma.com/file/LYlWNzvhMDh907l07mPPQk/Product-Web?node-id=1802%3A648)
...
<Canvas withToolbar>
    <Story parameters={{ docs: { source: { type: 'code' } } }} name="Modal with a sidebar">
        <ModalStoryStateProvider>
            <Button variant="primary">Open modal</Button>
...
### Minimalistic confirmation dialog

<Canvas withToolbar>
    <Story
        parameters={{ docs: { source: { type: 'code' } } }}
        name="Minimalistic confirmation dialog"
    >
        <ModalStoryStateProvider>
            <Button variant="primary">Open modal</Button>
            <Modal aria-label="Confirmation dialog" width="small">
                <Box padding="large">
