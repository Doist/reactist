...
import {
    ...
    ModalHeaderAndBodyStory,
    ModalHeaderBodyAndActionsStory,
    ModalScrollableBodyStory,
    PlainMediumModalStory,
    ModalPlaygroundStory } from './ModalStoryHelper'
...
export const Template = ({ data, ...args }) => (
...
<Canvas>
  <Story name="ModalHeaderOnlyStory">
    <ModalHeaderOnlyStory />
   </Story>
</Canvas>

<Canvas>
  <Story name="ModalHeaderAndBodyStory">
    <ModalHeaderAndBodyStory />
   </Story>
</Canvas>
...
<Canvas>
  <Story name="ModalHeaderBodyAndActionsStory">
    <ModalHeaderBodyAndActionsStory />
   </Story>
</Canvas>
...
<Canvas>
  <Story name="ModalScrollableBodyStory">
    <ModalScrollableBodyStory />
   </Story>
</Canvas>

<Canvas>
  <Story name="PlainMediumModalStory">
    <PlainMediumModalStory />
   </Story>
</Canvas>

<Canvas>
    <Story name="ModalPlaygroundStory" args={{
        plain: false,
        showCloseIcon: false,
        medium: false,
        large: false,
