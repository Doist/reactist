...
-   [Feat] A new notifications feature to trigger notification toasts, and render them stacked and floating in the viewport. It consists of a `ToastsProvider` and a `useToasts` hook.
