...
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__[/* __extends */ "b"])(KeyCapturer, _super);
  ...
  function KeyCapturer() {
    ...
    _this._handleKeyEvent = function (event) {
      ...
      if (Object.values(SUPPORTED_KEYS).includes(key)) {
        if (typeof _this.props["on" + key] === 'function') {
          // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
          // @ts-ignore Dynamic type not expressible in TypeScript.
          _this.props["on" + key]();

          if (_this.props["propagate" + key] !== true) {
  ...
  KeyCapturer.prototype.render = function () {
    var _a;

    var _b = this.props,
        children = _b.children,
        _c = _b.eventName,
        eventName = _c === void 0 ? 'onKeyDown' : _c;
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.cloneElement(
    /** @type {React.ReactElement} */
    children, (_a = {}, _a[eventName] = this._handleKeyEvent, _a));
  };
...
KeyCapturer.propTypes = {
  ...
  eventName: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.string
};
