...
/* harmony import */ var _styles_error_message_less__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21);
/* harmony import */ var _styles_error_message_less__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_styles_error_message_less__WEBPACK_IMPORTED_MODULE_1__);
...
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__[/* __extends */ "b"])(ErrorMessage, _super);
  /**
   * @param {Props} props
  ...
  ErrorMessage.prototype.UNSAFE_componentWillReceiveProps = function (next_props) {
  ...
  ErrorMessage.prototype._isValidMessage = function (message) {
  ...
  ErrorMessage.prototype.render = function () {
    ...
    }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", null, message), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      onClick: this._hide,
...
ErrorMessage.propTypes = {
  ...
  message: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.node), prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.node]),

  /** Timeout after the error message disappears (in ms). */
  timeout: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.number,

  /** Optional callback that is invoked when the error message disappears. */
  onHide: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.func
};
