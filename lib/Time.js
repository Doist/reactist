(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("prop-types"), require("react"), require("classnames"), require("dayjs"));
	else if(typeof define === 'function' && define.amd)
		define("reactist", ["prop-types", "react", "classnames", "dayjs"], factory);
	else if(typeof exports === 'object')
		exports["reactist"] = factory(require("prop-types"), require("react"), require("classnames"), require("dayjs"));
	else
		root["reactist"] = factory(root["prop-types"], root["React"], root["classnames"], root["dayjs"]);
...
function (_React$Component) {
  ...
  function Popover() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_getClassNameForPosition", function (position) {
      ...
      var className = external_classnames_default()('reactist popover', {
        visible: visible
      });
  ...
  _createClass(Popover, [{
    ...
    value: function render() {
      ...
      var popoverContentClass = external_classnames_default()('reactist popover__content', popoverClassName);
      var wrapperClass = external_classnames_default()('reactist popover__wrapper', wrapperClassName);
...
// EXTERNAL MODULE: ./src/components/styles/time.less
...
var localizedFormat = __webpack_require__(11);
var localizedFormat_default = /*#__PURE__*/__webpack_require__.n(localizedFormat);

// CONCATENATED MODULE: ./src/components/utils/TimeUtils.js


external_dayjs_default.a.extend(localizedFormat_default.a);
var TimeUtils = {
  ...
  timeAgo: function timeAgo(timestamp) {
    ...
    var date = external_dayjs_default()(timestamp * 1000);
    date.locale(locale);
    ...
    if (diffDays > 1) {
      ...
      return "".concat(diffMinutes).concat(minutesSuffix);
    } else {
      return momentsAgo;
    }
  },
  formatTime: function formatTime(timestamp) {
    var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var _config$locale2 = config.locale,
        locale = _config$locale2 === void 0 ? 'en' : _config$locale2,
        _config$shortFormatCu2 = config.shortFormatCurrentYear,
        shortFormatCurrentYear = _config$shortFormatCu2 === void 0 ? this.SHORT_FORMAT_CURRENT_YEAR : _config$shortFormatCu2,
        _config$shortFormatPa2 = config.shortFormatPastYear,
        shortFormatPastYear = _config$shortFormatPa2 === void 0 ? this.SHORT_FORMAT_PAST_YEAR : _config$shortFormatPa2;
    var date = external_dayjs_default()(timestamp * 1000);
    date.locale(locale);

    if (date.isSame(external_dayjs_default()(), 'year')) {
      return date.format(shortFormatCurrentYear);
    } else {
      return date.format(shortFormatPastYear);
    }
  },
  formatTimeLong: function formatTimeLong(timestamp) {
    var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var _config$locale3 = config.locale,
        locale = _config$locale3 === void 0 ? 'en' : _config$locale3,
        _config$longFormat = config.longFormat,
        longFormat = _config$longFormat === void 0 ? this.LONG_FORMAT : _config$longFormat;
    var date = external_dayjs_default()(timestamp * 1000);
    date.locale(locale);
    return date.format(longFormat);
  }
};
/* harmony default export */ var utils_TimeUtils = (TimeUtils);
// CONCATENATED MODULE: ./src/components/Time.jsx
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_React$Component) {
  ...
  _createClass(Time, [{
    ...
    key: "_setHovered",
    value: function _setHovered(hovered, event) {
    ...
    key: "_renderTime",
    value: function _renderTime(config) {
      if (this.state.hovered) {
        if (this.props.expandFullyOnHover && !this.props.tooltipOnHover) {
          return utils_TimeUtils.formatTimeLong(this.props.time, config);
        }

        if (this.props.expandOnHover && !this.props.tooltipOnHover) {
          return utils_TimeUtils.formatTime(this.props.time, config);
        }
      }

      return utils_TimeUtils.timeAgo(this.props.time, config);
    }
  }, {
    key: "_refresh",
    ...
    value: function render() {
      ...
      return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("time", {
        className: className,
      ...
      }, this.props.tooltipOnHover ? external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Tooltip["default"], {
        text: this.props.tooltip || utils_TimeUtils.formatTimeLong(this.props.time, this.props.config),
        delayShow: 500
...
Time_Time.propTypes = {
  ...
  time: external_prop_types_default.a.number.isRequired,

  /** When hovering over time it expands to short absolute version. */
  expandOnHover: external_prop_types_default.a.bool,

  /** When hovering over time it expands to the full absolute version. */
  expandFullyOnHover: external_prop_types_default.a.bool,

  /** When hovering over time it shows a tooltip with the full absolute version. */
  tooltipOnHover: external_prop_types_default.a.bool,

  /** Refresh the component every DELAY seconds. */
  refresh: external_prop_types_default.a.bool,
...
/* harmony default export */ var components_Time = __webpack_exports__["default"] = (Time_Time);
...
function (_React$Component) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      var wrapperClass = classnames__WEBPACK_IMPORTED_MODULE_3___default()('reactist tooltip__wrapper', wrapperClassName);
      var tooltipClass = classnames__WEBPACK_IMPORTED_MODULE_3___default()('reactist tooltip__text', tooltipClassName, {
        inverted: inverted
      });
      var arrowClass = classnames__WEBPACK_IMPORTED_MODULE_3___default()('reactist tooltip__arrow', {
        inverted: inverted
      });
