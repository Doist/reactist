...
})(window, function(__WEBPACK_EXTERNAL_MODULE__0__, __WEBPACK_EXTERNAL_MODULE__1__, __WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__11__) {
...
var localizedFormat = __webpack_require__(12);
...
var TimeUtils = {
   ...
   * @param {Config} [config]
   */
  timeAgo: function (timestamp, config) {
    if (config === void 0) {
      config = {};
    }
    ...
    var _a = config,
        ...
        _c = _a.shortFormatCurrentYear,
        shortFormatCurrentYear = _c === void 0 ? this.SHORT_FORMAT_CURRENT_YEAR : _c,
        _d = _a.shortFormatPastYear,
        shortFormatPastYear = _d === void 0 ? this.SHORT_FORMAT_PAST_YEAR : _d,
        _e = _a.daysSuffix,
        daysSuffix = _e === void 0 ? 'd' : _e,
        _f = _a.hoursSuffix,
        hoursSuffix = _f === void 0 ? 'h' : _f,
        _g = _a.minutesSuffix,
        minutesSuffix = _g === void 0 ? 'm' : _g,
        _h = _a.momentsAgo,
        momentsAgo = _h === void 0 ? 'moments ago' : _h;
   ...
   * @param {Config} [config]
   */
  formatTime: function (timestamp, config) {
    if (config === void 0) {
      config = {};
    }
   ...
   * @param {Config} [config]
   */
  formatTimeLong: function (timestamp, config) {
    if (config === void 0) {
      config = {};
    }
    ...
    var _a = config,
        ...
        locale = _b === void 0 ? 'en' : _b,
        _c = _a.longFormat,
        longFormat = _c === void 0 ? this.LONG_FORMAT : _c;
    var date = external_dayjs_default()(timestamp * 1000);
    date.locale(locale);
...
/** @class */
function (_super) {
  Object(tslib_es6["b" /* __extends */])(Time, _super);
  /**
   * @param {Props} props
   */
  ...
  Time.prototype.render = function () {
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("time", {
      ...
      onMouseEnter: function (event) {
        return _this._setHovered(true, event);
      },
      onMouseLeave: function (event) {
        return _this._setHovered(false, event);
      }
