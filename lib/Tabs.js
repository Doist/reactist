...
function (_React$Component) {
  ...
  function Tabs(props, context) {
    ...
    react__WEBPACK_IMPORTED_MODULE_1___default.a.Children.toArray(_this.props.children);
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var children =
      /** @type {React.Component<TabProps>[]} */
      react__WEBPACK_IMPORTED_MODULE_1___default.a.Children.toArray(this.props.children);
      var activeTab = children[this.state.activeTabIndex] || children[0] || null;
      var cls = classnames__WEBPACK_IMPORTED_MODULE_3___default()("reactist_tabs".concat(this.props.spreadLayout ? '--spreadlayout' : ''));
