...
function (_React$Component) {
  ...
  function Tabs(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderTabLinks", function (tabs) {
      return tabs.map(function (t, i) {
        ...
        var className = classnames__WEBPACK_IMPORTED_MODULE_3___default()('reactist tabs__header--item', {
          disabled: disabled,
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var cls = classnames__WEBPACK_IMPORTED_MODULE_3___default()('reactist', 'tabs', this.props.spreadLayout ? 'tabs--spreadlayout' : null);
...
var Tab = function Tab(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: classnames__WEBPACK_IMPORTED_MODULE_3___default()('reactist tabs__tab', className)
  }, children);
};
